...
public class TarotBoard extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image backgroundImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/assets/background_image.png")));
        ...
        for (int i = 0; i < NUM_CARDS; i++) {
            ...
            Image cardFrontImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/assets/card_front.png")));
            Image cardBackImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/assets/card_back.png")));
        ...
        for (int i = 0; i < colors.length; i++) {
            ...
            BufferedImage bwFrontImage = loadImage("assets/front_poker_chips.jxl");
            BufferedImage bwBackImage = loadImage("assets/back_poker_chips.jxl");
